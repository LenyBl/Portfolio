        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col l4 offset-l2 s12">
                    ...
                    <ul>
                        <li><a class="black-text text-darken-2" href="https://www.linkedin.com/in/leny-blee-4b184b307"
                                target="_blank">Linkedin</a><i class="material-icons black-text"></i></li>
                        <li><a class="black-text text-darken-2" href="https://www.instagram.com/leny.blee/"
                                target="_blank">Instagram</a></li>
                                <li><a class="black-text text-darken-2" href="https://github.com/LenyBl"
